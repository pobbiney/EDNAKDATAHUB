                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"   method="POST" action="{{route('customer-registration.add-permit-registration-form-infrastructure-process')}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label>Structures on the site  </label>
                                                                    <input type="text" name="structures" class="form-control" placeholder="Structures on the site Structures on the site"  value="{{ old('structures', $user->structures ?? '') }}"/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="water" class="form-control" placeholder="Access to water (source, quantity)"  value="{{ old('water', $user->water ?? '') }}"/>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="power" class="form-control" placeholder="Access to power (type, source, quantity)"  value="{{ old('power', $user->power ?? '') }}"/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="drainage" class="form-control" placeholder="Drainage provision in the project area "  value="{{ old('drainage', $user->drainage ?? '') }}"/>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="water_body" class="form-control" placeholder="Nearness to water body"  value="{{ old('water_body', $user->water_body ?? '') }}"/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="road_access" class="form-control" placeholder="Access to road to project site  "  value="{{ old('road_access', $user->road_access ?? '') }}"/>
                                                        ...
                                                        <div class="row">
                                                             <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="other" class="form-control" placeholder="Other major utilities proposed or existing on site   "  value="{{ old('other', $user->other ?? '') }}"/>
                                                        ...
                                                        <div class="text-end">
                                                            <a href="{{ route('customer-registration.permit-registration-form-project') }}" class="btn btn-soft-secondary" style="float: left">Previous</a>
