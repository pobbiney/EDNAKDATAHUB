                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"  method="POST" action="{{route('customer-registration.add-permit-registration-form-app-process')}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label>Name of Proponent</label>
                                                                    <input type="text" name="proponent_name" class="form-control" placeholder="Enter Proponent's Name" value="{{ old('proponent_name', $user->proponent_name ?? '') }}"/>
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="contact_person" class="form-control" placeholder="Enter Contact Person's Name" value="{{ old('contact_person', $user->contact_person ?? '') }}"/>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label>City</label>
                                                                    <input type="text" name="city" class="form-control" placeholder="Enter  City" value="{{ old('city', $user->city ?? '') }}"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="position" class="form-control" placeholder="Enter Position" value="{{ old('position', $user->position ?? '') }}"/>
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="contact_number" class="form-control" placeholder="Enter Contact Number" value="{{ old('contact_number', $user->contact_number ?? '') }}"/>
                                                        ...
                                                        <input type="hidden" name="application_id"value="{{ old('application_id', $user->formID ?? '') }}"/>
