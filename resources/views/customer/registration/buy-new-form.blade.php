            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Buy Form</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="solid-tab1">
                    <div class="row">
                                                ...
                                                @endif
                                                <form action="{{ route('customer-finance-setup-sell-forms-process') }}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-xl-4">
                                                           <div class="mb-3">
                                                                <label >Applicant</label>
                                                                    ...
                                                                    <input type="text" class="form-control" name="applicant_name" placeholder="Applicant Name" value="{{$formsale->applicantName}}" readonly>
                                                        ...
                                                        <div class="col-xl-4">
                                                           <div class="mb-3">
                                                                <label  >Telephone</label>
                                                                    ...
                                                                    <input type="text" class="form-control" name="telephone" value="{{$formsale->tell }}" readonly>
