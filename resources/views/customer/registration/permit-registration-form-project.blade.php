                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"   method="POST" action="{{route('customer-registration.add-permit-registration-form-project-process')}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label>Project Title</label>
                                                                    <input type="text" name="project_title" class="form-control" placeholder="Enter Project Title" value="{{ old('project_title', $user->project_title ?? '') }}"/>
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="plot_number" class="form-control" placeholder="Enter House/Plot No" value="{{ old('plot_number', $user->plot_number ?? '') }}"/>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="street_name" class="form-control" placeholder="Enter  Street Name" value="{{ old('street_name', $user->street_name ?? '') }}"/>
                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="mb-3">
                                                                    <label  >Sector</label>
                                                                        ...
                                                                        <option value="" selected disabled {{ old('sector', $user->sector_id ?? '') == '' ? 'selected' : '' }}>--SELECT SECTOR--</option>
                                                                        @foreach($sec as $sec)
                                                                        <option value="{{$sec->id}}" {{ old('sector', $user->sector_id ?? '') == $sec->id ? 'selected' : '' }}>{{$sec->name}}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control catname" name="category">
                                                                        <option value="" selected disabled>--SELECT CATEGORY--</option>
                                                                         <option value="" selected disabled {{ old('category', $user->cat_id ?? '') == '' ? 'selected' : '' }}>--SELECT SECTOR--</option>
                                                                        @foreach($catlist as $catlist)
                                                                        <option value="{{$catlist->id}}" {{ old('category', $user->cat_id ?? '') == $catlist->id ? 'selected' : '' }}>{{$catlist->name}}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control typename" name="type">
                                                                        <option value="" selected disabled>--SELECT TYPE--</option>
                                                                         <option value="" selected disabled {{ old('type', $user->type_id ?? '') == '' ? 'selected' : '' }}>--SELECT SECTOR--</option>
                                                                        @foreach($typelist as $typelist)
                                                                        <option value="{{$typelist->id}}" {{ old('type', $user->type_id ?? '') == $typelist->id ? 'selected' : '' }}>{{$typelist->name}}</option>
                                                                        @endforeach
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" name="project_description" > {{ old('project_description', $user->project_description ?? '') }}</textarea>
                                                          ...
                                                          <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" name="scope" >{{ old('scope', $user->scope ?? '') }}</textarea>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="gps" class="form-control" placeholder="Enter GPS" value="{{ old('gps', $user->gps ?? '') }}"/>
                                                             ...
                                                             <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    <label> Town</label>
                                                                    <input type="text" name="town" class="form-control" placeholder="Enter Town " value="{{ old('town', $user->town ?? '') }}"/>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label>Region</label>
                                                                     <select class="form-control changeregion" name="region">
                                                                        <option value="" selected disabled {{ old('region', $user->region ?? '') == '' ? 'selected' : '' }}>--Choose Region--</option>
                                                                        @foreach($regionsList as $list)
                                                                        <option value="{{ $list->id }}" {{ old('region', $user->region ?? '') == $list->id ? 'selected' : '' }}>{{$list->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                             ...
                                                             <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select   name="district" class="select2 form-control districtname" id="select2-placeholder-single">
                                                                         <option value="" selected disabled {{ old('district', $user->district ?? '') == '' ? 'selected' : '' }}>--Choose District--</option>
                                                                        @foreach($data as $lists)
                                                                        <option value="{{ $lists->id }}" {{ old('district', $user->district ?? '') == $lists->id ? 'selected' : '' }}>{{$lists->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                 <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="landmark" class="form-control" placeholder="Enter Landmark" value="{{ old('landmark', $user->landmark ?? '') }}">
                                                                 </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                 <div class="mb-3">
                                                                    <label>Adjacent land  Uses (Existing)</label>
                                                                    <input type="text" name="land_uses" class="form-control" placeholder="Enter Land Uses" value="{{ old('land_uses', $user->land_uses ?? '') }}">
                                                                 </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                 <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" name="site_description">{{ old('site_description', $user->site_description ?? '') }}</textarea>
                                                         ...
                                                         <div class="text-end">
                                                            <a href="{{ route('customer-registration.permit-registration-form-app') }}" class="btn btn-soft-secondary" style="float: left">Previous</a>
