                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('customer-store-environmental-impact',Crypt::encrypt($decodeId))}}" method="POST">
                                                @csrf
                                                 <button type="button" id="add-impact" class="btn btn-info float-end">Add Environmental Impact</button>
