                                    ...
                                    <ul>
                                        ...
                                        <li data-target="content8">
                                            <a href="javascript:void(0);" class="active subdrop">
                                                ...
                                                <span class="fs-14 fw-medium ms-2"> Application Approval</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div id="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->sector->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->category->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->type->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->street_name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->getRegion->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <p class="mt-1">{{$project->getDistrict->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div id="content7" class="displayContent">
                        <div class="row">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Review Application Page</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3"> 
                                            <p>Evaluation of the significance of the identified impacts, considering factors like the magnitude, duration, and extent of the impact. </p>
                                             <h5 class="mt-2">{{$reviewapp->evaluation ?? ''}}</h5>
                                        </div>
                                        <h4>Screening Decision /Recommendation</h4>
                                        <p>Categorization of the project based on the severity of its environmental impacts, determining whether it requires further environmental assessment </p>
                                        <div class="mb-3">
                                               <h5 class="mt-2">{{$reviewapp->getdecision->name ?? ''}}</h5>
                                        </div>
                                        <h4>Recommendations</h4>
                                        <p>Suggestions for appropriate mitigation measures to minimize negative impacts and enhance positive impacts, as well as recommendations for further environmental assessment if necessary. </p>
                                        <div class="mb-3">
                                             <h5 class="mt-2">{{$reviewapp->recommendation?? ''}}</h5>
                                        </div>
                                    </div>
                                </div>
                        </div>
                     ...
                     <div id="content8" class="displayContent">
                        <div class="row">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Approve Application Page</h5>
                                    </div>
                                    <div class="card-body">
                                         <form enctype="multipart/form-data"   method="POST" action="{{route('approve-permit-review-process')}}">
                                            @csrf
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p>Categorization of the project based on the severity of its environmental impacts, determining whether it requires further environmental assessment </p>
                                                    <div class="mb-3">
                                                        <select class="form-control" name="decision_id">
                                                            <option value="" selected disabled>--SELECT--</option>
                                                            @foreach ($list as $lists )
                                                                <option value="{{ $lists->id }}">{{ $lists->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('decision_id') <small style="color:red"> {{ $message}}</small> @enderror
                                                    </div>
                                                    <h4>Recommendations</h4>
                                                    <p>Suggestions for appropriate mitigation measures to minimize negative impacts and enhance positive impacts, as well as recommendations for further environmental assessment if necessary. </p>
                                                    <div class="mb-3">
