                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                             <form enctype="multipart/form-data" action="{{ route('edit-station-process',$id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Name</label>
                                                                            <input type="text" class="form-control" name="name" placeholder="Enter Station Name" value="{{ $datas->name }}">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-control changeregion" name="region">
                                                                            ...
                                                                            @foreach($regs as $list)
                                                                            <option  @if($list->id==$datas->region_id ) selected @endif value="{{ $list->id }}" >{{$list->name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-control districtname" name="district">
                                                                            ...
                                                                            <option  @if($list->id==$datas->district_id ) selected @endif value="{{ $list->id }}" >{{$list->name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="town" class="form-control" placeholder="Enter Twon" value="{{ $datas->town }}"/>
                                                                        @error('town') <small style="color:red"> {{ $message}}</small> @enderror
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="col-form-label">GPS Address</label>
                                                                        <input type="text" name="gps" class="form-control" placeholder="Enter GPS Address" value="{{ $datas->gps }}"/>
