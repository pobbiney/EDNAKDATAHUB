                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form enctype="multipart/form-data" action="{{ route('add-region-process') }}" method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                                               ...
                                                               <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="code" class="form-control" placeholder="Enter Region Code">
