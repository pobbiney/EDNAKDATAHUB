                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form enctype="multipart/form-data" action="{{ route('edit-district-process',$id) }}" method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label class="form-label">Name</label>
                                                                        <input type="text" class="form-control" name="name" placeholder="Enter District Name" value="{{ $datas->name }}"  >
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control" name="region">
                                                                        ...
                                                                        @foreach($regs as $procats)
                                                                        <option @if($procats->id==$datas->region_id ) selected @endif value="{{$procats->id}}">{{$procats->name}}</option>
                                                                    @endforeach
                                                                    </select>
