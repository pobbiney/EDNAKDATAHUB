        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="solid-tab1">
                    ...
                    @endif
                    <form action="{{ route('finance-setup-application-forms-edit-view-process',$id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <div class="col-lg-9">
                                       <input type="text" class="form-control" name="form_name" value="{{ $data->formName }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-lg-9">
                                       <select id="form_type" name="form_type" class="form-select select2" data-allow-clear="true">
                                            <option value="">-- SELECT --</option>
                                            <option value="New" @if ($data->formType == 'New') selected @endif>New</option>
                                            <option value="Renew" @if ($data->formType == 'Renew') selected @endif>Renew</option>
                                        </select>
