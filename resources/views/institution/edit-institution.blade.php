                         		...
                         		<div class="card-body">
								   ...
								   <div class="tab-content">
									   <div class="tab-pane show active text-muted" id="fill-pill-home" role="tabpanel">
                                            <form enctype="multipart/form-data" action="{{ route('edit-institution-process',$id) }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label class="col-lg-3 col-form-label">Name</label>
                                                            <input type="text" name="name" class="form-control" placeholder="Enter Institution Name" value="{{ $data->name }}">
                                                    ...
                                                    <div class="col-md-4">
                                                         <div class="mb-3">
                                                            ...
                                                            <input type="text" name="short_name" class="form-control" placeholder="Enter Short Name" value="{{ $data->short_name }}">
                                                 ...
                                                 <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                         <div class="mb-3">
                                                            ...
                                                            <input type="number" name="telephone" class="form-control" placeholder="Enter Telephone Number" value="{{ $data->telephone }}">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control changecategory" name="category">
                                                                ...
                                                                <option @if($listcat->id == $data->category_id) selected @endif value="{{$listcat->id}}">{{$listcat->name}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control typename" name="type">
                                                                ...
                                                                <option @if($listtype->id == $data->type_id) selected @endif value="{{$listtype->id}}">{{$listtype->name}}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" name="about" rows="7">{{ $data->about}}</textarea>
