...
$subpageName = "bill-payments-generate";
...
<div class="content">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Bills & Payments</h3>
                    <ul class="breadcrumb">
                ...
                <div class="card bg-white">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item"><a class="nav-link active"  href="#solid-tab2" data-bs-toggle="tab">Bills & Payments</a></li>
                        </ul>
    ...
    $(document).on("click","#find",function(e){
      ...
      if(parameter === ''){
        document.getElementById("find").disabled = false;
          ...
          $.ajax({
              type:"POST",
              url:"{{ route('billPayment-forms-search-process')}}",
              data:form,
              success: function (d) {
