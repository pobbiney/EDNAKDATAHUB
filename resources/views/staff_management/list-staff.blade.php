@php $pageName = "staff"; $subpageName = "staff_list"; @endphp
...
<i class="tf-icons ti ti-camera" style="color: white"></i>
</a> 
...
<div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
  <form method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('create-staff-photo-process')}}">
    @csrf
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel1">Upload Staff  ID/Photo</h5>
                      ...
                      <div class="row g-4" style="margin-top:5px ">
                            <div class="col mb-0">
                                ...
                                <select class="form-select" name="id_type">
                                    ...
                                    <option value="Divers License">Divers License</option>
                                </select>
                                <small class="text-danger">@error('id_type'){{$message}}@enderror </small> 
                            </div>
                            <div class="col mb-0">
                                <label for="dobBasic" class="form-label"><b>ID Number</b></label>
      ...
      <div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
        <form method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('upload-staff-supervisor-process')}}">
          @csrf
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <div class="modal-body">
                            ...
                            <div class="row g-4">
                              ...
                              <select   class="select2 form-select" data-allow-clear="true" name="supervisor_id">
                                ...
                                <option value="{{$procats->staff_id}}">{{$procats->surname}} {{$procats->firstname}}</option>
                                @endforeach
                            </select>  
