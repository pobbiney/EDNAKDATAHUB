                ...
                <div class="card bg-white">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item"><a class="nav-link active"  href="#solid-tab2" data-bs-toggle="tab">General</a></li>
...
@section('scripts')
  <script>
    ...
    if (enddate.length == 0) {
        ...
        $.ajax({
            url:"{{ route('reports-sales-satistic-general-process') }}",
            type:'POST',
            data:{
                "_token": "{{ csrf_token() }}",
                'startdate':startdate,
  ...
  <script>
    ...
    if (year.length == 0) {
        ...
        $.ajax({
            url:"{{ route('reports-sales-year-general-process') }}",
            type:'POST',
            data:{
                "_token": "{{ csrf_token() }}",
                'year':year
