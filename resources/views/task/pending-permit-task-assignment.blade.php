            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Pending Permit Task Assignment </li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <div class="search-set">
                    <h3>Pending Permit Task Assignment</h3>
            </div> 
        </div>
        <div class="card-body">
             <ul class="nav nav-tabs nav-tabs-solid mb-3">
                <li class="nav-item"><a class="nav-link active" href="{{route('pending-permit-task-assignment')}}" >Pending Permit Application </a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('completed-permit-task')}}"  >Completed Permit Jobs </a></li>
                            ...
                            <table class="table " id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('view-inspection-permit-details',Crypt::encrypt($task->permitapp->id))}} " target="_" class="btn btn-sm btn-success" style="color: white">Process</a>
