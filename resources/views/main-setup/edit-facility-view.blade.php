                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                             <form action="{{ route('main-setup-facility-edit-view-process',$id) }}" method="POST">
                                                                @csrf
                                                               <div class="mb-3">
                                                                    <label class="col-lg-3 col-form-label">Name</label>
                                                                    
                                                                        <input type="text" class="form-control" name="classification" value="{{ $data->name }}">
                                                                        @error('classification') <small style="color:red"> {{ $message}}</small> @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="card-title">List All Facilities  </h5>
                                                        </div>
                                                        <div class="card-body">
                                                             <div class="table-responsive">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>{{$busCLassItem->name}}</td>
                                                                        <td><a style="color:white;" href="{{ route('main-setup-facility-edit-view', Crypt::encrypt($busCLassItem->id)) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a></td>
                                                                    </tr>
                                                                    @endforeach
