                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="card-title">Add New Facility Type</h5>
                                                        </div>
                                                        <div class="card-body">
                                                            <form action="{{ route('main-setup-facility-type-insert-process') }}" method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    ...
                                                                    <label class="col-lg-3 col-form-label">Classification</label>
                                                                        ...
                                                                        <select id="type_classification" name="type_classification" class="form-select select2" data-allow-clear="true">
                                                                            ...
                                                                            @foreach ($busCLass as $busCLassItem)
                                                                                <option value="{{ $busCLassItem->id }}">{{ $busCLassItem->name }}</option> 
                                                                            @endforeach
                                                                        </select>
