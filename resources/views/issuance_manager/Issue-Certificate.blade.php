            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Issue Permit </li>
                    </ol>
                </nav>
            </div>
        </div>
                         ...
                         <div class="table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td >
                                        @if ($app->issuance)
                                        <a   class="btn btn-sm btn-danger" style="color: white">Certificate Issued</a>
                                    @else
                                        <a data-bs-toggle="modal"  id="showmodal" data-bs-target="#standard-modal" data-url="{{ route('get-certificate-id',$app->id)  }}"    class="btn btn-sm btn-success" style="color: white"> Issue Certificate</a>
                                        @endif              
                                    </td>
                                </tr>
                                        @php
