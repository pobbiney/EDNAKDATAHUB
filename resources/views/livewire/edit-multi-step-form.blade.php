<div>
    <div>
        <form wire:submit.prevent="editStaff">
            ...
            <div class="step-one">
                <div class="bs-stepper wizard-numbered mt-2">
                    ...
                    <div class="row g-6" style="margin-left: 10px;margin-right:10px;margin-top:10px">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control"  wire:model="title" id="title" >
                        ...
                        <div class="col-sm-4 form-password-toggle">
                            <label class="form-label" for="firstname">Firstname</label>
                                <input type="firstname"   class="form-control" placeholder="Enter Firstname""  wire:model="firstname" id="first_name">
                                <small class="text-danger">@error('firstname'){{$message}}@enderror </small> 
                        </div>
                    </div>
                    <div class="row g-6" style="margin-left: 10px;margin-right:10px;margin-top:2px">
                        <div class="col-sm-4">
                            <label class="form-label" for="confirm-password">Othername</label>
                            <input type="text"   class="form-control" placeholder="Enter Other Name"  wire:model="othername" id="other_name">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="date"   class="form-control dob-picker" placeholder="YYYY-MM-DD" / wire:model="dob" id="dob">
                    ...
                    <div class="row g-6" style="margin-left: 10px;margin-right:10px;margin-top:2px">
                        <div class="col-sm-4">
                            ...
                            <select   class="select2 form-select" data-allow-clear="true" wire:model="nationality" id="nationality">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control"  wire:model="marital_status_id" id="marital_status_id">
                                <option value="" selected disabled>--Choose Option--</option>
                    ...
                    <div class="row g-6" style="margin-left: 10px;margin-right:10px;margin-top:2px;">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select   class="select2 form-select changeregion" data-allow-clear="true" wire:model="region">
                                ...
                                @foreach($regs as $reg)
                                <option value="{{$reg->reg_code}}">{{$reg->region_name}}</option>
                                @endforeach
                            </select> 
