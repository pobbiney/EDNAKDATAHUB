                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"   method="POST" action="{{route('registration.add-permit-registration-form-project-process')}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                         ...
                                                         <div class="text-end">
                                                            <a href="{{ route('registration.permit-registration-form-app') }}" class="btn btn-soft-secondary" style="float: left">Previous</a>
