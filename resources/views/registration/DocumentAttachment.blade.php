                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$list->contact_number}}</td>
                                                        ...
                                                        <td>   <button data-bs-toggle="modal" data-id="{{ $list->id }}" id="showmodal"  data-bs-target="#standard-modal" class="btn btn-primary"><i class="fe fe-upload"></i> Attach Document</button></td>
...
<script>
    $(document).on('click','#showmodal',function(e){
        ...
        document.getElementById("showmodal").disabled = true;
         ...
         $.ajax({
        type:"POST",
        url:"{{ route('application-attach-drawings-get-forms') }}",
        data:{
            "_token": "{{ csrf_token() }}",
            'formsID': formsID
        },
