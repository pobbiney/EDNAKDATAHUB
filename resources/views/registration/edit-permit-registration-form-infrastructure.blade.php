                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"   method="POST" action="{{route('registration.edit-permit-registration-form-infrastructure-process',$id)}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="text-end">
                                                            <a href="{{ route('registration.edit-permit-registration-form-project',Crypt::encrypt($user->id) ) }}" class="btn btn-soft-secondary" style="float: left">Previous</a>
