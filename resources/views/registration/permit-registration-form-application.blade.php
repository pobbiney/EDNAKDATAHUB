                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"  method="POST" action="{{route('registration.add-permit-registration-form-application-process')}}">
                                                           @csrf
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label>Name of Proponent</label>
                                                                    <input type="text" name="proponent_name" class="form-control" placeholder="Enter Proponent's Name"  />
