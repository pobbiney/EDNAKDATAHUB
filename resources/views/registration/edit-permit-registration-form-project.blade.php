                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="mb-3">
                                                                    <label  >Project Classification</label>
                                                                        ...
                                                                        <option value="" selected disabled  >--SELECT PROJECT CLASSIFICATION--</option>
                                                                        @foreach($projectclass as $projectclass)
                                                                        <option  @if ($datas->project_class==$projectclass->id) selected @endif  value="{{$projectclass->id}}" >{{$projectclass->name}}</option>
                                                                        @endforeach
                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="mb-3">
                                                                    <label  >Project Classification</label>
                                                                        ...
                                                                        <option @if ($datas->project_type==$projecttype->id) selected @endif  value="{{$projecttype->id}}" >{{$projecttype->name}}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="mb-3">
                                                                    <label  >No of Floors</label>
                                                                       <select class="form-control" name="floor_number"  >
                                                                                @for ($y = 1; $y<= 10; $y++)
                                                                                <option value="{{$datas->floor_number}}">{{$datas->floor_number}}</select>
