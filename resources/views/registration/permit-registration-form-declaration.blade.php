                         ...
                         <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane active" id="seller-details">
                                                ...
                                                <form enctype="multipart/form-data"   method="POST" action="{{route('registration.add-permit-registration-form-declaration-process')}}">
                                                           @csrf
                                                      
                                                        <p style="margin: 0; padding: 0;font-size:large">
                                                            <span style="font-size: x-large">I</span>, <input type="text" class="form-control" name="applied_by" style="display: inline-block; width: 400px; vertical-align: middle;" /> @error('applied_by') <small style="color:red"> {{ $message}}</small> @enderror
                                                        ...
                                                        <div class="text-end">
                                                            <a href="{{ route('registration.permit-registration-form-infrastructure') }}" class="btn btn-soft-secondary" style="float: left">Previous</a>
