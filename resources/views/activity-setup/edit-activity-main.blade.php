            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update Activity </li>
                    </ol>
                </nav>
            </div>
        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('activity-setup-activity-edit-process',$id) }}" method="POST">
                                                                @csrf
                                                               <div class="mb-3">
                                                                    <label class="col-lg-3 col-form-label">Name</label>
                                                                   
                                                                        <input type="text" class="form-control" name="activity" value="{{ $data->activity }}">
                                                                        @error('activity') <small style="color:red"> {{ $message}}</small> @enderror
                                                                    
                                                                </div>
                                                               <div class="mb-3">
                                                                    <label class="col-lg-3 col-form-label">Responsibility</label>
                                                                    
                                                                        <select id="activity_type" name="activity_type" class="form-select select2" data-allow-clear="true">
                                                                            <option value="">-- To be Performed By --</option>

                                                                            @foreach ($activityClass as $activityClassItem)
                                                                                <option value="{{ $activityClassItem->id }}" @if ($data->activity_type == $activityClassItem->id) selected
                                                                                    @endif>{{ $activityClassItem->name }}</option> 
                                                                            @endforeach
                                                                        </select>
                                                                        @error('activity_type') <small style="color:red"> {{ $message}}</small> @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="card-title">List All Activities</h5>
                                                        </div>
                                                        <div class="card-body">
                                                             <div class="table-responsive">
                                                                  <table class="table" id="myTable">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>{{$activityListItem->activity}}</td>
                                                                            <td>{{$activityListItem->getType()}}</td>
                                                                            <td><a style="color:white;" href="{{ route('activity-setup-activity-edit-view', Crypt::encrypt($activityListItem->id)) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a></td>
                                                                        </tr>
                                                                        @endforeach
