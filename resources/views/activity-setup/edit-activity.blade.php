            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update Activity Type </li>
                    </ol>
                </nav>
            </div>
        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="card-title">Update   Activity Type</h5>
                                                        </div>
                                                        <div class="card-body">
                                                             <form action="{{ route('activity-setup-facility-edit-view-process',$id) }}" method="POST">
                                                                    @csrf
                                                                   <div class="mb-3">
                                                                        <label class="col-lg-3 col-form-label">Name</label>
                                                                        
                                                                            <input type="text" class="form-control" name="type" value="{{ $data->name}}">
